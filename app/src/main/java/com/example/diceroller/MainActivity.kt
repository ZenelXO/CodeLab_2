...
import com.example.diceroller.data.ArtInfo
import com.example.diceroller.ui.theme.ArtSpaceAppTheme
...
fun ArtSpaceApp() {
    ...
    val artimages = listOf(
        R.drawable.canarias1,
        R.drawable.canarias2,
        R.drawable.canarias3,
        R.drawable.canarias4
    )
